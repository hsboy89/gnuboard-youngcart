...
try {
    ...
    $posts = [
        ['2025-02-20 다무상회, 디휴먼브릿지, 스윔닥터(SDmall)이 손을잡고 스포츠테크 혁신 수영 특화 솔루션 개발을 추진합니다.', '다무상회는 디휴먼브릿지, 스윔닥터와 함께 수영 특화 솔루션 개발을 위한 협업을 시작했습니다.', '관리자', 'admin'],
        ['2024-10-08 2024 제주 펫 페어에서 다무상회가 Pet Tech 세미나를 하고 왔습니다.', '2024년 제주 펫 페어에서 다무상회의 Pet Tech 세미나가 성공적으로 개최되었습니다.', '관리자', 'admin']
    ];
